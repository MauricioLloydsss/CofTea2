...
public class MainAdapterIngredientsStocks extends FirebaseRecyclerAdapter<MainModelIngridients, MainAdapterIngredientsStocks.myViewHolder> {

    private MainModelIngridients originalModel;
    private int originalQuantity; // Variable to store the original quantity

    public MainAdapterIngredientsStocks(@NonNull FirebaseRecyclerOptions<MainModelIngridients> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myViewHolder holder, @SuppressLint("RecyclerView") int position, @NonNull MainModelIngridients model) {
